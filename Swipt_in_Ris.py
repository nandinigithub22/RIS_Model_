...
# SWIPT IMPLEMENTATION

p = 0.8  # power splitting ratio
q = 0.7  # Energy Harvesting Efficiency

# Power harvested using SWIPT
P_harvested = P_r * (1 - p) * Ar * q

# Power used for information decoding
P_decoded = P_r * p * Ar
...
print("If we implement swipt, Power Harvested :", P_harvested)
print("If we implement swipt, Power Decoded :", P_decoded)
print("------------------------------------------------------------")
